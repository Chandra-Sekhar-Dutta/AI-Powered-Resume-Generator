...
const Education = ({ enableNext }) => {
  ...
  useEffect(() => {
    resumeInfo && setEducation(resumeInfo.education || [formField])
  }, []);
  ...
  const removeEducation = () =>
    education.length > 1 && setEducation(education.slice(0, -1))
  ...
  useEffect(() => {
    ...
    // disable Next until saved & complete
          ...
          >
            ...
            <div className="flex justify-between items-center mt-6">
              <div className="flex gap-3">
                ...
                <Button variant="destructive" onClick={removeEducation}>
                  - Delete
                </Button>
              </div>
              <Button
                ...
                type="button"
                onClick={onSave}
                disabled={loading} // ✅ not disabled for incomplete form
                className="px-6"
              >
                {loading ? (
